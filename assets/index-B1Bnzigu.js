import{P as w,a2 as g,aa as x,T as u,Y as n,ax as t}from"./Button-BTXMOV36.js";import{n as o,c as k,o as v}from"./if-defined-BRldWvwP.js";import"./index-CRdo-Vy5.js";import"./index-BrfS0Hje.js";import"./index-tNDqjKZq.js";const M=w`
  button {
...
`;var p=function(c,e,l,r){var h=arguments.length,i=h<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,l):r,C;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,l,r);else for(var d=c.length-1;d>=0;d--)(C=c[d])&&(i=(h<3?C(i):h>3?C(e,l,i):C(e,l))||i);return h>3&&i&&Object.defineProperty(e,l,i),i};const W={browser:Z,dao:V,defi:b,defiAlt:m,eth:E,layers:H,lock:_,login:D,network:A,nft:j,noun:z,profile:U,system:R,coinbase:L,meld:P,onrampCard:$,moonpay:S,stripe:q,paypal:O,google:B,pencil:G,lightbulb:F,solana:T,bitcoin:y};let f=class extends u{constructor(){super(...arguments),this.name="browser",this.size="md"}render(){return this.style.cssText=`
