import{F as ie,ap as Z,P as K,aj as q,K as U,Y as se,J as _,aq as oe,G as ne,I as ae,j as R,r as y,x as c,a2 as L,ah as C,a3 as D,M as I,N as ce,X as ee,W as te,R as E,O as F,$ as V,Q as le,L as M,T as ue}from"./globalDisconnect-DEHmIGkh.js";import{n as p,c as g,o as h,r as d}from"./if-defined-DD_1_acj.js";import{D as de,T as pe}from"./index-CVhz9YrC.js";import"./index-i65RN3RT.js";import"./index-BAZBxnpC.js";import"./index-D2vU-kRu.js";import"./index-B7RfgT_Z.js";import{O as Y}from"./index-CkntE5FT.js";import"./index-DTCIio-U.js";import"./index-BKdQC-7I.js";import"./index-BhDhECzZ.js";import"./index-gtzDq4NN.js";import"./index-BftLqECp.js";import"./dayjs.min-DsMxAas2.js";import"./index-4szKfCc7.js";const N={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},G={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},me={providers:Z,selectedProvider:null,error:null,purchaseCurrency:N,paymentCurrency:G,purchaseCurrencies:[N],paymentCurrencies:[],quotesLoading:!1},l=ie(me),u={state:l,subscribe(s){return ae(l,()=>s(l))},subscribeKey(s,e){return ne(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=U.state.activeChain===se.CHAIN.SOLANA?"SOL":"USDC",t=_.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",oe),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||G,l.purchaseCurrency=s.purchaseCurrencies[0]||N,await q.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await q.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=Z,l.selectedProvider=null,l.error=null,l.purchaseCurrency=N,l.paymentCurrency=G,l.purchaseCurrencies=[N],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},he=R`
  :host {
    width: 100%;
  }
