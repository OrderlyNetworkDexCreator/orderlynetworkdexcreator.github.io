import{n as h,Y as f,t as o,p as g,O as n,s as u}from"./property-BxmscnVo.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"2778c5828739799f4fdbf80f93ddc59dfb2850d9"};var r=new e.Error().stack;r&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[r]="ed47aada-e03b-4076-bb87-9589e59eedae",e._sentryDebugIdIdentifier="sentry-dbid-ed47aada-e03b-4076-bb87-9589e59eedae")}catch{}})();var c=Object.defineProperty,y=Object.getOwnPropertyDescriptor,s=(e,r,d,i)=>{for(var a=i>1?void 0:i?y(r,d):r,l=e.length-1,p;l>=0;l--)(p=e[l])&&(a=(i?p(r,d,a):p(a))||a);return i&&a&&c(r,d,a),a};let t=class extends h{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var e;return f`<svg
  ...
  `;s([n({type:String,reflect:!0})],t.prototype,"size",2);s([n({type:String,reflect:!0})],t.prototype,"weight",2);s([n({type:String,reflect:!0})],t.prototype,"color",2);s([n({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([u("ph-dots-three")],t);export{t as PhDotsThree};
