import{aj as _,am as j,an as R,K as d,$ as y,N as h,T as l,ab as c,a7 as O}from"./AuthContext-DaWnPcyq.js";import{n as v,c as p,o as P,r as T}from"./if-defined-7gGxLq9E.js";import{e as U,n as L}from"./index-D1I3PF0t.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return R(u,()=>i(u))},subscribeKey(i,e){return j(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
