import{K as R,N as k,T as a,$ as L,a9 as C,ar as p,a3 as O,P as Y,ab as V,a4 as z,a2 as E,a5 as F}from"./AuthContext-DaWnPcyq.js";import{n as l,c as _,o as j,r as v}from"./if-defined-7gGxLq9E.js";import{T as A,D as W}from"./index-7ZqsmoK4.js";import"./index-vVaRTkZk.js";import"./index-DftRpYh5.js";import"./index-kaZumaZS.js";var N;(function(o){o.approve="approved",o.bought="bought",o.borrow="borrowed",o.burn="burnt",o.cancel="canceled",o.claim="claimed",o.deploy="deployed",o.deposit="deposited",o.execute="executed",o.mint="minted",o.receive="received",o.repay="repaid",o.send="sent",o.sell="sold",o.stake="staked",o.trade="swapped",o.unstake="unstaked",o.withdraw="withdrawn"})(N||(N={}));const U=R`
  :host > wui-flex {
    display: flex;
...
`;var w=function(o,t,e,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(o,t,e,r);else for(var c=o.length-1;c>=0;c--)(n=o[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};let d=class extends k{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return a`
    ...
    `}templateDescription(){var e;const t=(e=this.descriptions)==null?void 0:e[0];return t?a`
        ...
        `:null}};d.styles=[L,G];w([l()],d.prototype,"type",void 0);w([l({type:Array})],d.prototype,"descriptions",void 0);w([l()],d.prototype,"date",void 0);w([l({type:Boolean})],d.prototype,"onlyDirectionIcon",void 0);w([l()],d.prototype,"status",void 0);w([l()],d.prototype,"direction",void 0);w([l({type:Array})],d.prototype,"images",void 0);w([l({type:Array})],d.prototype,"price",void 0);w([l({type:Array})],d.prototype,"amount",void 0);w([l({type:Array})],d.prototype,"symbol",void 0);d=w([_("wui-transaction-list-item")],d);const K=R`
  :host {
    min-height: 100%;
  }
...
`;var x=function(o,t,e,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(o,t,e,r);else for(var c=o.length-1;c>=0;c--)(n=o[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};const D="last-transaction",M=7;let g=class extends k{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.page="activity",this.caipAddress=C.state.activeCaipAddress,this.transactionsByYear=p.state.transactionsByYear,this.loading=p.state.loading,this.empty=p.state.empty,this.next=p.state.next,p.clearCursor(),this.unsubscribe.push(C.subscribeKey("activeCaipAddress",t=>{t&&this.caipAddress!==t&&(p.resetTransactions(),p.fetchTransactions(t)),this.caipAddress=t}),C.subscribeKey("activeCaipNetwork",()=>{this.updateTransactionView()}),p.subscribe(t=>{this.transactionsByYear=t.transactionsByYear,this.loading=t.loading,this.empty=t.empty,this.next=t.next}))}firstUpdated(){this.updateTransactionView(),this.createPaginationObserver()}updated(){this.setPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return a` ${this.empty?null:this.templateTransactionsByYear()}
    ...
    ${!this.loading&&this.empty?this.templateEmpty():null}`}updateTransactionView(){var r;const t=(r=C.state.activeCaipNetwork)==null?void 0:r.caipNetworkId;p.state.lastNetworkInView!==t&&(p.resetTransactions(),this.caipAddress&&p.fetchTransactions(O.getPlainAddress(this.caipAddress))),p.setLastNetworkInView(t)}templateTransactionsByYear(){return Object.keys(this.transactionsByYear).sort().reverse().map(e=>{const r=parseInt(e,10),s=new Array(12).fill(null).map((i,n)=>{var u;const c=A.getTransactionGroupTitle(r,n),h=(u=this.transactionsByYear[r])==null?void 0:u[n];return{groupTitle:c,transactions:h}}).filter(({transactions:i})=>i).reverse();return s.map(({groupTitle:i,transactions:n},c)=>{const h=c===s.length-1;return n?a`
        ...
        <wui-transaction-list-item
          ...
          .descriptions=${s}
        ></wui-transaction-list-item>
      `:b?u.map(($,S)=>{const B=A.getTransferDescription($),T=e&&S===u.length-1;return a` <wui-transaction-list-item
          date=${r}
          direction=${$.direction}
          id=${T&&this.next?D:""}
          status=${h}
