import{aI as U,b7 as Ie,aM as ve,b2 as x,aJ as _,aZ as C,b4 as f,aB as l,p as I,R as Se,l as v,t as ke,P as y,u as O,F as _e,z as N,K as ce,J as E,aW as me,k as m,i as P,x as M,Y as R,B as Ce,G,bc as $e,bb as Re,b5 as Oe,n as T,T as z,b6 as h,bi as Ue,a0 as Le,aL as Ne,a_ as qe,D as ge}from"./components-wyVIVVNd.js";(function(){try{var t=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};t.SENTRY_RELEASE={id:"d48aad66738a791ef83dfa7aaa14e8a9f6f3fdc2"};var e=new t.Error().stack;e&&(t._sentryDebugIds=t._sentryDebugIds||{},t._sentryDebugIds[e]="7b907446-3be8-4a80-ae2d-893fa1e50175",t._sentryDebugIdIdentifier="sentry-dbid-7b907446-3be8-4a80-ae2d-893fa1e50175")}catch{}})();const De=U`
  :host {
    position: relative;
  }
...
`;var B=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};let k=class extends C{constructor(){super(),this.unsubscribe=[],this.amount=u.state.amount,this.namespace=void 0,this.paymentAsset=u.state.paymentAsset,this.activeConnectorIds=T.state.activeConnectorIds,this.caipAddress=void 0,this.exchanges=u.state.exchanges,this.isLoading=u.state.isLoading,this.initializeNamespace(),this.unsubscribe.push(u.subscribeKey("amount",e=>this.amount=e)),this.unsubscribe.push(T.subscribeKey("activeConnectorIds",e=>this.activeConnectorIds=e)),this.unsubscribe.push(u.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(u.subscribeKey("isLoading",e=>this.isLoading=e)),u.fetchExchanges(),u.setSelectedExchange(void 0)}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    >
      ...
      `)}templateSeparator(){return l`<wui-separator text="or" bgColor="secondary"></wui-separator>`}async onWalletPayment(){if(!this.namespace)throw new Error("Namespace not found");this.caipAddress?z.push("PayQuote"):(await T.connect(),await G.open({view:"PayQuote"}))}onExchangePayment(e){u.setSelectedExchange(e),z.push("PayQuote")}async onDisconnect(){try{await v.disconnect(),await G.open({view:"Pay"})}catch{console.error("Failed to disconnect"),R.showError("Failed to disconnect")}}getWalletProperties({namespace:e}){if(!e)return{name:void 0,image:void 0};const n=this.activeConnectorIds[e];if(!n)return{name:void 0,image:void 0};const s=T.getConnector({id:n,namespace:e});if(!s)return{name:void 0,image:void 0};const i=P.getConnectorImage(s);return{name:s.name,image:i}}};k.styles=rt;B([h()],k.prototype,"amount",void 0);B([h()],k.prototype,"namespace",void 0);B([h()],k.prototype,"paymentAsset",void 0);B([h()],k.prototype,"activeConnectorIds",void 0);B([h()],k.prototype,"caipAddress",void 0);B([h()],k.prototype,"exchanges",void 0);B([h()],k.prototype,"isLoading",void 0);k=B([_("w3m-pay-view")],k);const ot=U`
  :host {
    display: inline-flex;
    align-items: center;
    justify-content: center;
...
`;var j=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};const ct=3,ut=2,lt=.3,dt="200px",pt={"accent-primary":Ue.tokens.core.backgroundAccentPrimary};let D=class extends C{constructor(){super(...arguments),this.rings=ct,this.duration=ut,this.opacity=lt,this.size=dt,this.variant="accent-primary"}render(){const e=pt[this.variant];this.style.cssText=`
    ...
    `}renderRing(e,n){const i=`animation-delay: ${e/n*this.duration}s;`;return l`<div class="pulse-ring" style=${i}></div>`}};D.styles=[Ie,ot];j([x({type:Number})],D.prototype,"rings",void 0);j([x({type:Number})],D.prototype,"duration",void 0);j([x({type:Number})],D.prototype,"opacity",void 0);j([x()],D.prototype,"size",void 0);j([x()],D.prototype,"variant",void 0);D=j([_("wui-pulse")],D);const Ee=[{id:"received",title:"Receiving funds",icon:"dollar"},{id:"processing",title:"Swapping asset",icon:"recycleHorizontal"},{id:"sending",title:"Sending asset to the recipient address",icon:"send"}],Ae=["success","submitted","failure","timeout","refund"],ht=U`
  :host {
    display: block;
    height: 100%;
    width: 100%;
...
`;var Te=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};let J=class extends C{constructor(){super(),this.unsubscribe=[],this.quote=u.state.quote,this.unsubscribe.push(u.subscribeKey("quote",e=>this.quote=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var n,s,i;const e=E.formatNumber(((n=this.quote)==null?void 0:n.origin.amount)||"0",{decimals:((s=this.quote)==null?void 0:s.origin.currency.metadata.decimals)??0,round:6}).toString();return l`
    ...
    `}};J.styles=[yt];Te([h()],J.prototype,"quote",void 0);J=Te([_("w3m-pay-fees")],J);const bt=U`
  :host {
    display: block;
    width: 100%;
  }
...
`;var Pe=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};let Z=class extends C{constructor(){super(),this.unsubscribe=[],this.selectedExchange=u.state.selectedExchange,this.unsubscribe.push(u.subscribeKey("selectedExchange",e=>this.selectedExchange=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=!!this.selectedExchange;return l`
    ...
    `}dispatchConnectOtherWalletEvent(){this.dispatchEvent(new CustomEvent("connectOtherWallet",{detail:!0,bubbles:!0,composed:!0}))}};Z.styles=[bt];Pe([x({type:Array})],Z.prototype,"selectedExchange",void 0);Z=Pe([_("w3m-pay-options-empty")],Z);const xt=U`
  :host {
    display: block;
    width: 100%;
  }
...
`;var Et=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};let oe=class extends C{render(){return l`
    ...
    `}};oe.styles=[xt];oe=Et([_("w3m-pay-options-skeleton")],oe);const At=U`
  :host {
    display: block;
    width: 100%;
  }
...
`;var ee=function(t,e,n,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(a=(i<3?o(a):i>3?o(e,n,a):o(e,n))||a);return i>3&&a&&Object.defineProperty(e,n,a),a};const It=300;let W=class extends C{constructor(){super(),this.unsubscribe=[],this.options=[],this.selectedPaymentAsset=null}disconnectedCallback(){var n,s;this.unsubscribe.forEach(i=>i()),(n=this.resizeObserver)==null||n.disconnect();const e=(s=this.shadowRoot)==null?void 0:s.querySelector(".pay-options-container");e==null||e.removeEventListener("scroll",this.handleOptionsListScroll.bind(this))}firstUpdated(){var n,s;const e=(n=this.shadowRoot)==null?void 0:n.querySelector(".pay-options-container");e&&(requestAnimationFrame(this.handleOptionsListScroll.bind(this)),e==null||e.addEventListener("scroll",this.handleOptionsListScroll.bind(this)),this.resizeObserver=new ResizeObserver(()=>{this.handleOptionsListScroll()}),(s=this.resizeObserver)==null||s.observe(e),this.handleOptionsListScroll())}render(){return l`
    ...
    `}payOptionTemplate(e){var pe,he;const{network:n,metadata:s,asset:i,amount:a="0"}=e,c=m.getAllRequestedCaipNetworks().find(H=>H.caipNetworkId===n),g=`${n}:${i}`,L=`${(pe=this.selectedPaymentAsset)==null?void 0:pe.network}:${(he=this.selectedPaymentAsset)==null?void 0:he.asset}`,Q=g===L,V=E.bigNumber(a,{safe:!0}),Y=V.gt(0);return l`
      <wui-flex
        alignItems="center"
        justifyContent="space-between"
        gap="2"
