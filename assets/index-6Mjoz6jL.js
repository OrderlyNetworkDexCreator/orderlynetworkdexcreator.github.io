import{v as p,x as u,R as f,M as b,z as d}from"./localizedRoute-BXh1iEn7.js";import{n as g,r as m,c as v}from"./if-defined-BR1qeihA.js";import{T as l}from"./index-_XeiX5xz.js";const R={interpolate(i,e,o){if(i.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=i[0]||0,r=i[1]||0,t=e[0]||0,s=e[1]||0;return o<n?t:o>r?s:(s-t)/(r-n)*(o-n)+t}},M=p`
  :host {
    width: 100%;
    display: block;
  }
