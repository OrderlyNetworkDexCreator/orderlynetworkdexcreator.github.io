import{am as _,ap as R,aq as j,P as d,a2 as y,T as h,Y as l,ae as c,aa as O}from"./Button-BTXMOV36.js";import{n as v,c as p,o as P,r as T}from"./if-defined-BRldWvwP.js";import{e as U,n as L}from"./index-C_jTzd9p.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return j(u,()=>i(u))},subscribeKey(i,e){return R(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
