import{l as S,m as _,L as p,x as c,I as O,V as s,_ as f,v as b,aM as u,aL as D,b1 as y,o as d,aE as m,ba as E,b2 as $,aN as W,b7 as N,s as T,q as P}from"./components-BPyHaav6.js";import{W as C}from"./index-JCXpK_JQ.js";import"./index-DVmBE5Ad.js";import"./preload-helper-DhdKVgcq.js";import"./dayjs.min-9GguTl5N.js";import"./dijkstra-D3pmIIKo.js";import"./browser-ponyfill-nuzDz0cy.js";(function(){try{var r=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};r.SENTRY_RELEASE={id:"f23328cbf1bd8eb6c62973cc0d709e64bde7fe76"};var e=new r.Error().stack;e&&(r._sentryDebugIds=r._sentryDebugIds||{},r._sentryDebugIds[e]="ac367c05-0a65-40ee-94b6-146ee3f156f7",r._sentryDebugIdIdentifier="sentry-dbid-ac367c05-0a65-40ee-94b6-146ee3f156f7")}catch{}})();var F=function(r,e,t,a){var n=arguments.length,i=n<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,t):a,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,e,t,a);else for(var l=r.length-1;l>=0;l--)(o=r[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends C{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,a;try{if(this.authConnector){const n=S.state.activeChain,i=_.getConnections(n),o=(t=p.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await _.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((a=p.state.remoteFeatures)!=null&&a.emailCapture)return;if(p.state.siwx){O.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}O.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:b.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([u("w3m-email-verify-otp-view")],I);const L=D`
  wui-icon-box {
