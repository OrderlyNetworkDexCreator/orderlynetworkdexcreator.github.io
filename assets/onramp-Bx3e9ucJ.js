...
`;var W=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let O=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.paymentCurrency,this.currencies=u.state.paymentCurrencies,this.currencyImages=C.state.currencyImages,this.checked=V.state.isLegalCheckboxChecked,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),C.subscribeKey("currencyImages",e=>this.currencyImages=e),V.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=U.state,i=(a=U.state.features)==null?void 0:a.legalCheckbox,n=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var i;return c`
      ...
      `})}selectCurrency(e){e&&(u.setPaymentCurrency(e),P.close())}};O.styles=ye;W([d()],O.prototype,"selectedCurrency",void 0);W([d()],O.prototype,"currencies",void 0);W([d()],O.prototype,"currencyImages",void 0);W([d()],O.prototype,"checked",void 0);O=W([g("w3m-onramp-fiat-select-view")],O);const ge=R`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var z=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let k=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.purchaseCurrencies,this.tokens=u.state.purchaseCurrencies,this.tokenImages=C.state.tokenImages,this.checked=V.state.isLegalCheckboxChecked,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),V.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=U.state,i=(a=U.state.features)==null?void 0:a.legalCheckbox,n=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var i;return c`
      ...
      `})}selectToken(e){e&&(u.setPurchaseCurrency(e),P.close())}};k.styles=xe;z([d()],k.prototype,"selectedCurrency",void 0);z([d()],k.prototype,"tokens",void 0);z([d()],k.prototype,"tokenImages",void 0);z([d()],k.prototype,"checked",void 0);k=z([g("w3m-onramp-token-select-view")],k);const Ce=R`
  @keyframes shake {
    0% {
...
`;var I=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};const Ie={USD:"$",EUR:"€",GBP:"£"},Pe=[100,250,500,1e3];let x=class extends y{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=D.state.activeCaipAddress,this.loading=P.state.loading,this.paymentCurrency=u.state.paymentCurrency,this.paymentAmount=u.state.paymentAmount,this.purchaseAmount=u.state.purchaseAmount,this.quoteLoading=u.state.quotesLoading,this.unsubscribe.push(D.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),P.subscribeKey("loading",e=>{this.loading=e}),u.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}templateButton(){return this.caipAddress?c`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||P.open({view:"OnRampProviders"})}openModal(){P.open({view:"Connect"})}async onPaymentAmountChange(e){u.setPaymentAmount(Number(e.detail)),await u.getQuote()}async selectPresetAmount(e){u.setPaymentAmount(e),await u.getQuote()}};x.styles=Ae;I([p({type:Boolean})],x.prototype,"disabled",void 0);I([d()],x.prototype,"caipAddress",void 0);I([d()],x.prototype,"loading",void 0);I([d()],x.prototype,"paymentCurrency",void 0);I([d()],x.prototype,"paymentAmount",void 0);I([d()],x.prototype,"purchaseAmount",void 0);I([d()],x.prototype,"quoteLoading",void 0);x=I([g("w3m-onramp-widget")],x);export{f as W3mBuyInProgressView,$ as W3mOnRampActivityView,Q as W3mOnRampProvidersView,O as W3mOnrampFiatSelectView,k as W3mOnrampTokensView,x as W3mOnrampWidget,J as W3mWhatIsABuyView};
