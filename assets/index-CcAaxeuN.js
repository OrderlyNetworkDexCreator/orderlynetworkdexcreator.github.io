import{v as w,w as g,D as x,x as u,z as n,e as t}from"./localizedRoute-BXh1iEn7.js";import{n as o,c as k,o as v}from"./if-defined-BR1qeihA.js";import"./index-ChTehTMf.js";import"./index-DYsAksMp.js";import"./index-fZ1zU2Hn.js";const M=w`
  button {
...
`;var p=function(c,e,l,r){var h=arguments.length,i=h<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,l):r,C;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,l,r);else for(var d=c.length-1;d>=0;d--)(C=c[d])&&(i=(h<3?C(i):h>3?C(e,l,i):C(e,l))||i);return h>3&&i&&Object.defineProperty(e,l,i),i};const W={browser:Z,dao:V,defi:b,defiAlt:m,eth:E,layers:H,lock:_,login:D,network:A,nft:z,noun:j,profile:U,system:T,coinbase:L,meld:S,onrampCard:$,moonpay:P,stripe:R,paypal:O,google:B,pencil:G,lightbulb:F,solana:q,bitcoin:y};let f=class extends u{constructor(){super(...arguments),this.name="browser",this.size="md"}render(){return this.style.cssText=`
