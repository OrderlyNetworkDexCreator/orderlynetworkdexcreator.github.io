import{k as E,l as N,m as U,r as w,x as u,ap as _,R as l,a2 as h,P as x,N as v,Y as c,L as S,V as k,a5 as W,M as z,aq as M,Z as B}from"./globalDisconnect-BwfQ2Vw-.js";import{n as I,c as d,r as m,U as D}from"./if-defined-Di4EeOnb.js";import"./index-Baju-5_P.js";import"./index-DbgAnm08.js";import"./index-D7Q9BrPL.js";import{e as H,n as q}from"./index-BOdA3nuV.js";import"./index-B4IWTyjU.js";import"./index-gtzDq4NN.js";import"./clsx-B-dksMZM.js";import"./index-DW8hbQKv.js";const Y=E`
  :host {
    position: relative;
...
`;var O=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};const Z=6;let p=class extends w{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){var e;super(),this.loading=!1,this.timeoutTimeLeft=_.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=(e=l.state.data)==null?void 0:e.email,this.authConnector=h.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return u`
      <wui-flex
